...
mmdebstrap --variant=minbase --format=ext4 \
  ...
  --include="sysvinit-core,sysv-rc,orphan-sysvinit-scripts,elogind,libpam-elogind,dbus-x11,cinnamon,lightdm,firefox-esr,network-manager,init,iproute2,kmod,pciutils,procps,udev" \
  trixie rootfs.ext4
